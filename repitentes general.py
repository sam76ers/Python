...
df_sin_null.drop_duplicates(keep='first')
...
df1=df_sin_null.loc[(df['nivel']==nivel_curso)&(df['gestion']==gestion_curso)]
#Obtener los cursantes de un nivel y de una gestión anterior
df2=df_sin_null.loc[(df['nivel']==nivel_curso)&(df['gestion']==gestion_curso-1)]
